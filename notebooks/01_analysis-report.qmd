...
p_groups_violins <- plot_groups_violins(df)
```
...
if (params$save_figures) {
  ggsave(here("figures/group-violins.png"), p_groups_violins, dpi = 600)
}
```
...
# needs to run trace(corrplot,edit=TRUE) and add + 0.25 to line 449
