...
between aphantasics and controls. 
...
## Education, fields of study and occupation
...
We used partial correlations to identify the strongest unbiased links between 
variables for variable reduction, while reducing the bias from spurious correlations.
...
"sub-clusters" by dividing the mixed cluster between controls and aphants. We
display the analyses for the cluster and sub-cluster classifications below.
