...
custom_functions <- c(
  ...
  "R/04_plot/plot_violins.R",
  "R/04_plot/plot_correlations.R",
  "R/04_plot/plot_clusters_bic.R",
  "R/04_plot/plot_radars.R"
)
purrr::walk(custom_functions, ~ source(here::here(.)))

# Main objects -----------------------------------------------------------------

# Loading pre-extracted data and pre-computed correlations and models
df     <- readRDS(here::here("data/data-processed/data_tidied.rds"))
models <- readRDS(here::here("data/r-data-structures/models.rds"))
cors   <- readRDS(here::here("data/r-data-structures/correlations.rds"))$partial
